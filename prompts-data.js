window.PROMPTS_DATA = [
  {
    ...
    "useCase": "Scaffold docs for a new feature or product from scratch",
    "level": "Beginner",
    "badgeColor": "#0d9488",
    "promptText": "Act as an experienced technical writer with expertise in <mark>[INDUSTRY/DOMAIN]</mark>.\n\nI need to create documentation for <mark>[PRODUCT/FEATURE NAME]</mark>.\n\nHere is the context:\n\n- Target audience: <mark>[e.g., developers, end users, IT admins]</mark>\n- Documentation type: <mark>[e.g., user guide, API reference, release notes]</mark>\n- Key functionality to cover: <mark>[LIST 3: 5 BULLET POINTS]</mark>\n- Tone: <mark>[e.g., formal, conversational, instructional]</mark>\n\nWrite a complete first draft including: an overview section, step-by-step instructions, and a troubleshooting section. Use clear headings, numbered steps for procedures, and plain language appropriate for the audience.",
    "copyPrompt": "Act as an experienced technical writer with expertise in [INDUSTRY/DOMAIN].\n\nI need to create documentation for [PRODUCT/FEATURE NAME].\n\nHere is the context:\n\n- Target audience: [e.g., developers, end users, IT admins]\n- Documentation type: [e.g., user guide, API reference, release notes]\n- Key functionality to cover: [LIST 3: 5 BULLET POINTS]\n- Tone: [e.g., formal, conversational, instructional]\n\nWrite a complete first draft including: an overview section, step-by-step instructions, and a troubleshooting section. Use clear headings, numbered steps for procedures, and plain language appropriate for the audience.",
    "proTip": "",
    "tags": [
      "scaffold",
      "first",
  ...
  },
  {
    ...
    "useCase": "Rewrite jargon-heavy content for a general audience",
    "level": "Beginner",
    "badgeColor": "#0d9488",
    "promptText": "You are a technical writer specializing in plain language. Below is a piece of technical content written for expert-level readers. Rewrite it for <mark>[TARGET AUDIENCE, e.g., non-technical business users / beginners / customers]</mark>.\n\nOriginal content:\n\n<mark>[PASTE YOUR CONTENT HERE]</mark>\n\nGuidelines:\n- Replace all jargon with plain-language equivalents\n- Keep sentences under 20 words where possible\n- Use active voice throughout\n- Preserve all factual accuracy: do not omit critical information\n- Maintain the same structure (headings, lists, steps) as the original\n\nOutput the rewritten version followed by a short glossary defining any technical terms that could not be fully avoided.",
    "copyPrompt": "You are a technical writer specializing in plain language. Below is a piece of technical content written for expert-level readers. Rewrite it for [TARGET AUDIENCE, e.g., non-technical business users / beginners / customers].\n\nOriginal content:\n\n[PASTE YOUR CONTENT HERE]\n\nGuidelines:\n- Replace all jargon with plain-language equivalents\n- Keep sentences under 20 words where possible\n- Use active voice throughout\n- Preserve all factual accuracy: do not omit critical information\n- Maintain the same structure (headings, lists, steps) as the original\n\nOutput the rewritten version followed by a short glossary defining any technical terms that could not be fully avoided.",
    "proTip": "Describe the audience's exact technical level\n                  (for example, 'someone with no IT background') to improve results.",
    "tags": [
      "technical",
      "audience",
      "simplify",
  ...
  },
  {
    ...
    "useCase": "Document a REST endpoint with curl examples and schemas",
    "level": "Intermediate",
    "badgeColor": "#0d9488",
    "promptText": "You are a technical writer documenting a REST API. Write a reference entry for the following endpoint.\n\nEndpoint details:\n- Method: <mark>[GET / POST / PUT / DELETE]</mark>\n- Endpoint URL: <mark>[e.g., /api/v1/users/{id}]</mark>\n- Description: <mark>[WHAT THIS ENDPOINT DOES]</mark>\n- Authentication: <mark>[e.g., Bearer token, API key]</mark>\n- Request parameters: <mark>[LIST NAME, TYPE, REQUIRED/OPTIONAL, DESCRIPTION]</mark>\n- Request body (if applicable): <mark>[PASTE SCHEMA OR EXAMPLE]</mark>\n- Response codes and meanings: <mark>[e.g., 200, 400, 404, 500]</mark>\n- Example response: <mark>[PASTE SAMPLE JSON]</mark>\n\nFormat the output using standard API documentation structure with clearly labeled sections. Include a working curl example. Flag any parameters with constraints (e.g., max length, allowed values).",
    "copyPrompt": "You are a technical writer documenting a REST API. Write a reference entry for the following endpoint.\n\nEndpoint details:\n- Method: [GET / POST / PUT / DELETE]\n- Endpoint URL: [e.g., /api/v1/users/{id}]\n- Description: [WHAT THIS ENDPOINT DOES]\n- Authentication: [e.g., Bearer token, API key]\n- Request parameters: [LIST NAME, TYPE, REQUIRED/OPTIONAL, DESCRIPTION]\n- Request body (if applicable): [PASTE SCHEMA OR EXAMPLE]\n- Response codes and meanings: [e.g., 200, 400, 404, 500]\n- Example response: [PASTE SAMPLE JSON]\n\nFormat the output using standard API documentation structure with clearly labeled sections. Include a working curl example. Flag any parameters with constraints (e.g., max length, allowed values).",
    "proTip": "Paste actual schema or JSON examples to ensure\n                  accuracy. Use consistent formatting across all library entries.",
    "tags": [
      "write",
      "api",
      "schemas",
  ...
  },
  {
    ...
    "useCase": "Write one focused section for a newly shipped feature",
    "level": "Beginner",
    "badgeColor": "#0d9488",
    "promptText": "Act as a senior technical writer. Write a documentation section for a newly released product feature.\n\nFeature name: <mark>[FEATURE NAME]</mark>\nProduct: <mark>[PRODUCT NAME]</mark>\nTarget audience: <mark>[e.g., end users, administrators, developers]</mark>\nSection type: <mark>[e.g., Overview, How It Works, Getting Started, Configuration, Best Practices]</mark>\nWhere this section lives: <mark>[e.g., in a user guide, help center article, in-app tooltip, README]</mark>\n\nFeature description (your notes):\n<mark>[PASTE YOUR RAW NOTES, TICKET DESCRIPTION, OR FEATURE BRIEF HERE]</mark>\n\nWrite the section with:\n- A one-paragraph feature overview (what it is and why it matters to the user)\n- Prerequisites or requirements (if any)\n- Step-by-step instructions to use the feature\n- A note on any limitations, known issues, or edge cases\n- One concrete example showing a real-world use case\n\nUse clear headings, active voice, and second-person (\"you\") throughout.",
    "copyPrompt": "Act as a senior technical writer. Write a documentation section for a newly released product feature.\n\nFeature name: [FEATURE NAME]\nProduct: [PRODUCT NAME]\nTarget audience: [e.g., end users, administrators, developers]\nSection type: [e.g., Overview, How It Works, Getting Started, Configuration, Best Practices]\nWhere this section lives: [e.g., in a user guide, help center article, in-app tooltip, README]\n\nFeature description (your notes):\n[PASTE YOUR RAW NOTES, TICKET DESCRIPTION, OR FEATURE BRIEF HERE]\n\nWrite the section with:\n- A one-paragraph feature overview (what it is and why it matters to the user)\n- Prerequisites or requirements (if any)\n- Step-by-step instructions to use the feature\n- A note on any limitations, known issues, or edge cases\n- One concrete example showing a real-world use case\n\nUse clear headings, active voice, and second-person (\"you\") throughout.",
    "proTip": "Paste the Jira or GitHub ticket directly as the\n                  feature description. The AI extracts the relevant details automatically.",
    "tags": [
      "feature",
      "write",
      "newly",
  ...
  },
  {
    ...
    "useCase": "Buttons, tooltips, error messages, and onboarding text",
    "level": "Intermediate",
    "badgeColor": "#0d9488",
    "promptText": "You are a UX writer and technical writer specializing in UI microcopy. Write copy for the following UI elements in <mark>[PRODUCT NAME]</mark>.\n\nProduct context: <mark>[BRIEFLY DESCRIBE WHAT THE PRODUCT DOES]</mark>\nTone of voice: <mark>[e.g., professional and direct / friendly and approachable / minimal and technical]</mark>\nTarget user: <mark>[DESCRIBE USER]</mark>\n\nUI elements needed (complete the applicable items):\n- Page/screen title: <mark>[DESCRIBE SCREEN PURPOSE]</mark>\n- Primary button label: <mark>[DESCRIBE ACTION]</mark>\n- Secondary button label: <mark>[DESCRIBE ACTION]</mark>\n- Empty state message: <mark>[DESCRIBE CONTEXT: what is empty and why]</mark>\n- Error message for: <mark>[DESCRIBE ERROR SCENARIO]</mark>\n- Success message for: <mark>[DESCRIBE COMPLETION ACTION]</mark>\n- Tooltip for: <mark>[DESCRIBE FIELD OR ICON]</mark>\n- Onboarding tip: <mark>[DESCRIBE FEATURE OR STEP]</mark>\n\nFor each item: provide the copy, a one-line rationale, and one alternative option.",
    "copyPrompt": "You are a UX writer and technical writer specializing in UI microcopy. Write copy for the following UI elements in [PRODUCT NAME].\n\nProduct context: [BRIEFLY DESCRIBE WHAT THE PRODUCT DOES]\nTone of voice: [e.g., professional and direct / friendly and approachable / minimal and technical]\nTarget user: [DESCRIBE USER]\n\nUI elements needed (complete the applicable items):\n- Page/screen title: [DESCRIBE SCREEN PURPOSE]\n- Primary button label: [DESCRIBE ACTION]\n- Secondary button label: [DESCRIBE ACTION]\n- Empty state message: [DESCRIBE CONTEXT: what is empty and why]\n- Error message for: [DESCRIBE ERROR SCENARIO]\n- Success message for: [DESCRIBE COMPLETION ACTION]\n- Tooltip for: [DESCRIBE FIELD OR ICON]\n- Onboarding tip: [DESCRIBE FEATURE OR STEP]\n\nFor each item: provide the copy, a one-line rationale, and one alternative option.",
    "proTip": "Keep all copy within the UI framework character\n                  limits. Include rationale to help stakeholders approve with confidence.",
    "tags": [
      "messages",
      "write",
      "tooltips",
  ...
  },
  {
    ...
    "useCase": "Consistent, user-friendly notes for any software update",
    "level": "Intermediate",
    "badgeColor": "#0d9488",
    "promptText": "You are a technical writer responsible for software release communications. Write professional release notes for the following update.\n\nProduct: <mark>[PRODUCT NAME]</mark>\nVersion: <mark>[VERSION NUMBER]</mark>\nRelease date: <mark>[DATE]</mark>\nAudience: <mark>[e.g., end users, developers, IT teams]</mark>\n\nChanges to document:\n- New features: <mark>[LIST]</mark>\n- Improvements/enhancements: <mark>[LIST]</mark>\n- Bug fixes: <mark>[LIST]</mark>\n- Deprecations or breaking changes: <mark>[LIST, OR \"None\"]</mark>\n- Known issues: <mark>[LIST, OR \"None\"]</mark>\n\nFormat requirements:\n- Lead with a one-paragraph summary of the most impactful changes\n- Use clear category headings\n- For each item: one sentence describing what changed and why it matters to the user\n- Flag any breaking changes prominently with a warning label\n- Close with upgrade instructions or a link placeholder",
    "copyPrompt": "You are a technical writer responsible for software release communications. Write professional release notes for the following update.\n\nProduct: [PRODUCT NAME]\nVersion: [VERSION NUMBER]\nRelease date: [DATE]\nAudience: [e.g., end users, developers, IT teams]\n\nChanges to document:\n- New features: [LIST]\n- Improvements/enhancements: [LIST]\n- Bug fixes: [LIST]\n- Deprecations or breaking changes: [LIST, OR \"None\"]\n- Known issues: [LIST, OR \"None\"]\n\nFormat requirements:\n- Lead with a one-paragraph summary of the most impactful changes\n- Use clear category headings\n- For each item: one sentence describing what changed and why it matters to the user\n- Flag any breaking changes prominently with a warning label\n- Close with upgrade instructions or a link placeholder",
    "proTip": "Frame every change from the user perspective\n                  ('You can now...' rather than 'We added...').",
    "tags": [
      "friendly",
      "any",
      "user",
  ...
  },
  {
    ...
    "level": "Intermediate",
    "badgeColor": "#0d9488",
    "promptText": "You are a technical writer translating raw developer logs into user-facing release notes. Review the following list of <mark>[Git commits / Jira tickets]</mark>: \n\n&lt;logs&gt;\n<mark>[PASTE LOGS HERE]</mark>\n&lt;/logs&gt;\n\nGroup them logically into:\n- New Features\n- Bug Fixes\n- Under the Hood (performance and infrastructure)\n\nTranslate the developer jargon into plain English focused on user value. Ignore minor typo fixes or internal CI/CD commits. Use active voice and bullet points.",
    "copyPrompt": "You are a technical writer translating raw developer logs into user-facing release notes. Review the following list of [Git commits / Jira tickets]: \n\n<logs>\n[PASTE LOGS HERE]\n</logs>\n\nGroup them logically into:\n- New Features\n- Bug Fixes\n- Under the Hood (performance and infrastructure)\n\nTranslate the developer jargon into plain English focused on user value. Ignore minor typo fixes or internal CI/CD commits. Use active voice and bullet points.",
    "proTip": "Review the final output carefully to ensure no\n                  critical security fixes were accidentally grouped as \"Under the hood.\"",
    "tags": [
      "logs",
      "messy",
      "developer",
  ...
  },
  {
    ...
    "level": "Intermediate",
    "badgeColor": "#0d9488",
    "promptText": "You are an SEO specialist and technical writer. Review the following documentation article:\n\n&lt;article&gt;\n<mark>[PASTE ARTICLE HERE]</mark>\n&lt;/article&gt;\n\nGenerate the following:\n1. 5 highly clickable, SEO-optimized H1 title options\n2. A meta description (maximum 155 characters) that accurately summarizes the article and encourages users to click\n3. A list of 3-5 primary keywords that this article should target.",
    "copyPrompt": "You are an SEO specialist and technical writer. Review the following documentation article:\n\n<article>\n[PASTE ARTICLE HERE]\n</article>\n\nGenerate the following:\n1. 5 highly clickable, SEO-optimized H1 title options\n2. A meta description (maximum 155 characters) that accurately summarizes the article and encourages users to click\n3. A list of 3-5 primary keywords that this article should target.",
    "proTip": "",
    "tags": [
      "metadata",
      "seo",
  ...
  },
  {
    ...
    "useCase": "Create concise release notes or changelog entries",
    "level": "Intermediate",
    "badgeColor": "#0d9488",
    "promptText": "You are a technical writer creating release communications. Write a concise release summary for the following update.\n\nProduct or feature: <mark>[PRODUCT/FEATURE]</mark>\nVersion: <mark>[VERSION]</mark>\nRelease date: <mark>[DATE]</mark>\nAudience: <mark>[e.g., external developers / customer success / internal teams]</mark>\nKey updates: <mark>[LIST 3: 5 BULLET POINTS]</mark>\nRequired action: <mark>[e.g., upgrade, change configuration, no action needed]</mark>\n\nFormat the output as a short release summary followed by a bullet list of what changed, why it matters, and any action the reader should take.",
    "copyPrompt": "You are a technical writer creating release communications. Write a concise release summary for the following update.\n\nProduct or feature: [PRODUCT/FEATURE]\nVersion: [VERSION]\nRelease date: [DATE]\nAudience: [e.g., external developers / customer success / internal teams]\nKey updates: [LIST 3: 5 BULLET POINTS]\nRequired action: [e.g., upgrade, change configuration, no action needed]\n\nFormat the output as a short release summary followed by a bullet list of what changed, why it matters, and any action the reader should take.",
    "proTip": "Keep the summary short enough for a release note section or\n                internal status update.",
    "tags": [
      "summary",
      "write",
      "entries",
  ...
  },
  {
    ...
    "useCase": "Convert a meeting or interview recording into structured docs",
    "level": "Intermediate",
    "badgeColor": "#f59e0b",
    "promptText": "You are a technical writer. Below is a raw transcript from a <mark>[meeting / interview / demo / walkthrough]</mark>. Extract and organize the information into structured documentation.\n\nTranscript:\n&lt;transcript&gt;\n<mark>[PASTE TRANSCRIPT HERE]</mark>\n&lt;/transcript&gt;\n\nOutput the following:\n1. Summary: 3-5 bullet points of the key information covered\n2. Decisions made: any explicit decisions or agreements reached\n3. Action items: who is responsible for what (if mentioned)\n4. Draft documentation section: organize the technical content from this transcript into a clean, publishable doc section with headings and plain language. Remove filler words, repetition, and conversational noise\n\nAudience for the doc section: <mark>[e.g., developers, end users, internal team]</mark>",
    "copyPrompt": "You Te a technical writer. Below is a raw transcript. Extract and organize the information into structured documentation.\n\nTranscript:\n<transcript>\n[PASTE TRANSCRIPT HERE]\n</transcript>\n\nOutput:\n1. Summary: 3-5 bullet points\n2. Decisions made\n3. Action items (who, what)\n4. Draft documentation section: clean, publishable, plain language\n\nAudience: [e.g., developers, end users, internal team]",
    "proTip": "Use auto-generated captions from Zoom,\n                  Teams, or Google Meet as raw input. Imperfect transcripts still produce usable\n                  outputs.",
    "tags": [
      "recording",
      "interview",
      "turn",
  ...
  },
  {
    ...
    "useCase": "Narration script for a product walkthrough or tutorial video",
    "level": "Intermediate",
    "badgeColor": "#f59e0b",
    "promptText": "You are a technical writer creating a narration script for a product video. Write a voiceover script for the following video.\n\nVideo details:\n- Product: <mark>[PRODUCT NAME]</mark>\n- Video type: <mark>[e.g., product walkthrough, feature demo, onboarding tutorial, explainer]</mark>\n- Target length: <mark>[e.g., 2 minutes / 90 seconds]</mark>\n- Audience: <mark>[DESCRIBE]</mark>\n- Tone: <mark>[e.g., warm and encouraging / professional and direct]</mark>\n- Key steps or scenes to cover: <mark>[LIST IN ORDER]</mark>\n\nFormat the script as a two-column table:\n| Visual / On-screen action | Narration (voiceover text) |\n\nInclude an opening hook (first 10 seconds) and a clear call to action at the end. Keep sentences short: voiceover reads at roughly 130 words per minute.",
    "copyPrompt": "You are a technical writer creating a narration script for a product video.\n\nVideo details:\n- Product: [PRODUCT NAME]\n- Video type: [e.g., walkthrough, demo, tutorial]\n- Target length: [e.g., 2 minutes]\n- Audience: [DESCRIBE]\n- Tone: [e.g., warm / professional]\n- Key steps to cover: [LIST IN ORDER]\n\nFormat as two-column table: Visual / On-screen action | Narration (voiceover text)\nInclude opening hook and closing CTA. ~130 words per minute pacing.",
    "proTip": "Read the script aloud before recording to\n                  ensure it sounds natural.",
    "tags": [
      "narration",
      "write",
      "tutorial",
  ...
  },
  {
    ...
    "useCase": "Accessibility-ready captions and image descriptions at scale",
    "level": "Intermediate",
    "badgeColor": "#f59e0b",
    "promptText": "You are a technical writer specializing in accessibility. I need two things: cleaned-up captions for a video, and alt text for the screenshots used in associated documentation.\n\nRaw auto-generated captions (unedited):\n<mark>[PASTE RAW CAPTIONS HERE]</mark>\n\nScreenshots to describe (list them in order):\n<mark>[DESCRIBE EACH SCREENSHOT BRIEFLY, e.g., \"Screenshot 1: the login screen with an email field and a blue Sign In button\"]</mark>\n\nFor the captions:\n- Correct spelling, punctuation, and speaker identification errors\n- Keep timing markers if present\n- Do not change the meaning or add information not in the original\n\nFor the alt text:\n- Write functional alt text that describes what the image shows and why it matters in context\n- Keep each description under 125 characters\n- Do not start with \"Image of\" or \"Screenshot of\"",
    "copyPrompt": "You are a technical writer specializing in accessibility.\n\nRaw captions:\n[PASTE RAW CAPTIONS HERE]\n\nScreenshots to describe:\n[DESCRIBE EACH SCREENSHOT BRIEFLY]\n\nFor captions: correct errors, keep timing markers, do not change meaning.\nFor alt text: functional description of what is shown and why it matters in context. Under 125 characters. Do not start with \"Image of\" or \"Screenshot of\".",
    "proTip": "Describe the function, not the appearance.\n                  Use \"Submit button\" rather than \"blue rounded button.\"",
    "tags": [
      "captions",
      "scale",
      "alt",
  ...
  },
  {
    ...
    "level": "Intermediate",
    "badgeColor": "#14b8a6",
    "promptText": "You are a senior technical writer. Create a practical style guide for a documentation team.\n\nContext:\n- Company/product: <mark>[NAME]</mark>\n- Documentation types produced: <mark>[e.g., API docs, user guides, release notes, in-app help]</mark>\n- Primary audience: <mark>[e.g., developers, enterprise IT admins, general consumers]</mark>\n- Existing style references to follow: <mark>[e.g., Microsoft Writing Style Guide / Google Developer Docs / none]</mark>\n\nInclude these sections:\n1. Voice and tone: 3 defining principles with before/after examples\n2. Formatting rules: headings, lists, tables, code blocks\n3. Grammar and mechanics: punctuation, capitalization, numbers, dates\n4. Terminology: a starter glossary of 10 product-specific terms with approved usage\n5. What to avoid: 10 common mistakes with corrections\n6. Accessibility standards: plain language, alt text, link text\n\nKeep each section concise and practical. Use examples throughout.",
    "copyPrompt": "Create a practical style guide for a documentation team.\n\nContext:\n- Company/product: [NAME]\n- Docs produced: [e.g., API docs, user guides, release notes]\n- Primary audience: [DESCRIBE]\n- Style references: [e.g., Microsoft / Google / none]\n\nSections:\n1. Voice and tone: 3 principles with before/after examples\n2. Formatting rules: headings, lists, tables, code\n3. Grammar and mechanics\n4. Terminology: 10 product terms with approved usage\n5. What to avoid: 10 common mistakes with corrections\n6. Accessibility standards",
    "proTip": "Use the output as a starting draft.\n                  Build the best style guides through team discussion rather than top-down\n                  mandates.",
    "tags": [
      "style",
      "scratch",
      "guide",
